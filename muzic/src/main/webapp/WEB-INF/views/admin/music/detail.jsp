...
<div class="admin-container">
    ...
    <!-- 돌아가기 버튼 -->
    <a href="/admin/music/list" class="admin-btn btn-detail" style="margin-bottom:14px;display:inline-block;">← 목록으로</a>
    ...
    <!-- Comment form -->
    <form method="post" action="/admin/music/approve" class="admin-action-box">
    ...
    <form method="post" action="/admin/music/reject" class="admin-action-box">
        <input type="hidden" name="musicNo" value="${musicDto.musicNo}">
    ...
    <form method="post" action="/admin/music/approve-edit" class="admin-action-box">
        <input type="hidden" name="musicNo" value="${musicDto.musicNo}">
    ...
    <form method="post" action="/admin/music/approve-delete" class="admin-action-box">
        <input type="hidden" name="musicNo" value="${musicDto.musicNo}">
