...
<div class="container w-1000">
	<c:choose>
		...
		<c:otherwise>
			...
			<div class="cell product-detail-main" style="display: flex; gap: 60px; margin-bottom: 50px;">
				...
				<div style="flex-grow: 1; width: 60%; padding-top: 10px;">
					...
					<p style="font-size: 1.5em; color: #333; font-weight: bold; padding-bottom: 20px; border-bottom: 1px solid #eee; margin-bottom: 20px;">
						<fmt:formatNumber value="${goodsDto.goodsPoint}" pattern="#,###" /> point
					</p>
					...
					<form method="post" style="display: flex; flex-direction: column; gap: 20px;">
						...
						<div style="display: flex; align-items: center; justify-content: flex-start; gap: 20px;">
							...
							<div style="font-size: 1em; color: ${goodsDto.goodsQuantity == 0 ? 'black' : 'green'};">
								재고: 
						...
						<div style="display: flex; gap: 10px; margin-top: 10px;">
							<c:if test="${goodsDto.goodsQuantity > 0}">
								<button type="submit" class="btn btn-positive" formaction="buy" onclick="return confirm('구매하시겠습니까?');" style="flex-grow: 1;">
									바로구매</button>

								<button type="button" id="cartAddBtn" class="btn btn-neutral" style="flex-grow: 1;">
									장바구니</button>
							</c:if>
			...
			<div class="cell product-description-section" style="padding-top: 30px; border-top: 1px solid #ddd; margin-top: 30px;">
